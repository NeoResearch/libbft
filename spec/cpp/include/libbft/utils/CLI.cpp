...
Argument::Argument(char _shortName, bool _itHasValue, std::string _longName,
    ...
    : shortName(_shortName),
      itHasValue(_itHasValue),
      longName(std::move(_longName)),
      defaultValue(std::move(_defaultValue)) {}

char Argument::getShortName() const { return shortName; }

bool Argument::hasValue() const { return itHasValue; }

std::string Argument::getLongName() const { return longName; }

bool Argument::hasLongName() const { return !getLongName().empty(); }

std::string Argument::getDefaultValue() const { return defaultValue; }

bool Argument::hasDefaultValue() const { return !getDefaultValue().empty(); }
